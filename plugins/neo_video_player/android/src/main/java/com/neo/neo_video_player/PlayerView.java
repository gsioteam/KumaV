...
public class PlayerView extends GLSurfaceView {
    ...
    NeoVideoPlayerController mController;
    private NeoVideoPlayerController.OnFrameListener onFrameListener = new NeoVideoPlayerController.OnFrameListener() {
        @Override
        public void onFrame() {
            requestRender();
        }
    ...
    public PlayerView(Context context, NeoVideoPlayerController controller) {
        super(context);
    ...
    protected void onDetachedFromWindow() {
        ...
        Log.i("PlayerView", "onDetachedFromWindow");
    }
